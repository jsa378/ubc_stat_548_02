...
edges = r"C:\Users\jesse\Downloads\STAT 548\02\doctor-who-dataset\datasets\doctorwho.csv"
roles = r"C:\Users\jesse\Downloads\STAT 548\02\doctor-who-dataset\datasets\roles\doctorwho_roles.csv"
       
df = pd.read_csv(edges, nrows=10)
# g = nx.from_pandas_edgelist(df,'Source','Target',['Weight'])
G = nx.from_pandas_edgelist(df,'Source','Target','Weight')
roles = pd.read_csv(roles).set_index('Id')['Label'].map(lambda x: eval(x)).to_dict()
nx.set_node_attributes(G,roles,'roles')

# print(G.edges[('79B Aickman Road', 'Amy Pond')])
