...
model = gpflow.models.GPR(data=(L_of_G_shuffled_nodes, L_of_G_shuffled_node_weights), kernel=kernel)

opt = gpflow.optimizers.Scipy()
opt.minimize(model.training_loss, model.trainable_variables)

print("testing weights:", testing_weights)
y_mean, y_var = model.predict_y(testing_vertices)
print("predicted weights:", y_mean)
